...
const std::string declkey = "let";   //declaration keywork
...
Token Token_stream::get()
{
    ...
    char ch;
    std::cin.get(ch);            // look for any char including whitespace
...
double Symbol_table::define_name(std::string var, double val, bool con)
...
void print_help()
{
    std::cout << "Simple Calculator Manual\n"
         << "========================\n"
